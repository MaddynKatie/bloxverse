...
export const games = [
  ...
  },
  {
    ...
    description: 'Explore a beautifully crafted classic house with multiple rooms and a cozy atmosphere.',
  ...
  },
  {
    ...
    description: 'Team up and play touch football on a custom-built field. Score goals and dominate the field!',
    category: 'Sports',
    maxPlayers: 12,
    worldFloor: false,
    respawnY: -200,
