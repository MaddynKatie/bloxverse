import{a as e,c as t,i as n,l as r,n as i,s as a,t as o}from"./friends-5E0U1xWh.js";import"./modulepreload-polyfill-DfS4ul37.js";/* empty css             */import{t as s}from"./games-CnRz6IyJ.js";import{E as c,S as l,d as u,n as d,o as f,s as p,t as m,w as h}from"./firebase-Em72dDyo.js";var g=document.getElementById(`navCenter`),_=document.getElementById(`navRight`),v=document.getElementById(`gameGrid`),y=document.getElementById(`friendsSection`),b=document.getElementById(`friendsGrid`),x=document.getElementById(`friendRequests`);function S(e){let t=document.createElement(`div`);t.className=`game-card`,t.onclick=()=>C(e.id),t.innerHTML=`
