const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/games-BDoUuGij.js","assets/games-Ba71Bj4Y.js","assets/firebase-XHjplP5n.js"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-N-DOuI4P.js";/* empty css             */import{D as e,H as t,T as n,h as r,j as i,n as a,o,r as s,v as c}from"./firebase-XHjplP5n.js";import{r as l}from"./games-Ba71Bj4Y.js";import{c as u,i as d,n as f,o as p,r as m,s as h,t as g}from"./friends-Bo4P1ful.js";import{t as _}from"./preload-helper-D40adSEE.js";var v=document.getElementById(`navCenter`),y=document.getElementById(`navRight`),b=document.getElementById(`gameGrid`),x=document.getElementById(`friendsSection`),S=document.getElementById(`friendsGrid`),C=document.getElementById(`friendRequests`);function w(e){let t=document.createElement(`div`);return t.className=`game-card`,t.onclick=()=>window.location.href=`/bloxverse/game-detail.html?id=`+e.id,t.innerHTML=`
...
style="cursor:pointer;">
      ...
      `).join(``)}async function z(e){if(e.length===0){C.innerHTML=``;return}C.innerHTML=`<div style="font-size:13px;color:#8a8c8e;margin-bottom:8px;">Friend Requests</div><div class="friend-requests">`+e.map(e=>`
        ...
        `).join(``)+`</div>`}window._acceptRequest=async(e,t,n)=>{await g(e,t,n),B()},window._declineRequest=async e=>{await f(e),B()},window._removeFriend=async e=>{confirm(`Remove this friend?`)&&(await p(D,e),B())};async function B(){if(!D)return;let[e,n]=await Promise.all([d(D),m(D)]),r=await I(e);for(let e of n)try{let n=await i(t(o,`users`,e.from));e.fromUsername=n.exists()?n.data().username:`Unknown`}catch{e.fromUsername=`Unknown`}R(r),z(n)}function V(e){j&&j!==e&&j.classList.remove(`open`),e.classList.toggle(`open`),j=e.classList.contains(`open`)?e:null}n(a,async e=>{if(k&&=(k(),null),A&&=(A.goOffline(),null),e){if(await s(e.uid))return;D=e.uid;let n=e.displayName||`Player`,a=0;try{let r=await i(t(o,`users`,e.uid));if(r.exists()){let e=r.data();n=e.username||n,a=e.bux||0}}catch{}A=c(e.uid);let l=n.charAt(0).toUpperCase();v.innerHTML=M(),document.getElementById(`friendSearchInput`).addEventListener(`input`,N);let u=`buxValue`;y.innerHTML=`
            ...
            <div class="avatar-dropdown" id="userDropdown">
              ...
              <div class="dropdown-menu">
                <div class="dropdown-header">
                  <span class="dropdown-name">${n}</span>
        ...
        `;let d=document.querySelector(`#userDropdown .avatar-circle`),f=document.getElementById(`userDropdown`);d.addEventListener(`click`,e=>{e.stopPropagation(),V(f)}),k=r(e.uid,e=>{let t=document.getElementById(u);t&&(t.textContent=e.toLocaleString())},n,e.email),x.style.display=`block`,B()}else D=null,v.innerHTML=``,y.innerHTML=`<button class="login-btn" 
